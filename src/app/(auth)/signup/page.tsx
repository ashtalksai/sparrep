    ...
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="p-6 rounded-xl border border-[#1F2937] bg-[#111318]">
          <h1 className="font-display text-2xl text-[#F9FAFB] mb-1">Create your account</h1>
          <p className="text-[#6B7280] text-sm mb-6">3 free sessions included. No credit card.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="name" className="text-[#6B7280] text-xs">Full name</Label>
              <Input
                id="name"
                value={form.name}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-[#6B7280] text-xs">Work email</Label>
              <Input
                id="email"
                type="email"
                value={form.email}
        ...
        <p className="mt-4 text-center text-xs text-[#6B7280]/60">
          By creating an account, you agree to our{" "}
          <Link href="/terms" className="hover:text-[#6B7280] underline">Terms</Link> and{" "}
